...
export const NavigationMenuSection = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-[50] w-full bg-white">
      <div className="w-full px-6 py-3 md:px-12 md:py-0 lg:px-24 xl:px-40">
        <div className="layout-container relative flex w-full items-center justify-between gap-8 md:h-[67px]">
          <a
            href="#inicio"
            className="flex h-[40px] w-[220px] shrink-0 items-center md:h-full"
      ...
      >
        <div className="border-t border-black/10 bg-white px-6 py-4 md:px-12 lg:px-24 xl:px-40">
          <div className="layout-container flex flex-col gap-2">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
